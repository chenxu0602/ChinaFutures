...
if __name__ == "__main__":
	...
	parser.add_argument("--file", nargs="?", type=str, default="DY8_20170927.csv", dest="file", help="DY8 file name")
	parser.add_argument("--pnl", nargs="?", type=str, default="Close", dest="pnl", help="price field for PnL calculation")
